...
import { ChevronLeft, Calculator, TrendingDown, TrendingUp } from "lucide-react";
					...
					<div className="flex flex-row items-center justify-between gap-4">
						...
						<div className="flex items-center space-x-4">
							...
							<div className="flex items-center gap-2">
								<h3 className="text-lg sm:text-sm font-semibold text-gray-900 dark:text-gray-100">{selectedToken.name}</h3>

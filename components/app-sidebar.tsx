...
import { Home, PieChart, Wallet2, Globe, TrendingUp, BarChart3, User } from "lucide-react"
            ...
            >
              <Link href="/" className="flex items-center gap-3 px-3 py-2">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">CryptoFolio</span>
                  <span className="truncate text-xs text-muted-foreground">Portfolio Tracker</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
